...
struct mcc_ast_single_expression *mcc_ast_new_single_expression_call_expr(struct mcc_ast_identifier *identifier_call,
                                                            struct mcc_ast_arguments *arguments );
...
struct mcc_ast_expression *mcc_ast_new_expression_binary_op(enum mcc_ast_binary_op op, struct mcc_ast_single_expression *rhs,
...
struct mcc_ast_identifier *mcc_ast_new_identifier(char *val_identifier);
...
struct mcc_ast_declaration *mcc_ast_new_declaration
        (enum mcc_ast_data_type type, struct mcc_ast_literal *array_size, struct mcc_ast_identifier *ident);
...
struct mcc_ast_statement *mcc_ast_new_statement_ret( enum mcc_ast_data_type dt, struct mcc_ast_expression* ret_expr);
...
struct mcc_ast_parameter {
    ...
    int param_len;
    int param_size;
    struct mcc_ast_declaration **decl_parameter;
};

struct mcc_ast_parameter *mcc_ast_new_parameter(struct mcc_ast_declaration *decl_parameter, struct mcc_ast_parameter *parameter);
...
struct mcc_ast_function *
mcc_ast_new_function(enum mcc_ast_data_type type, struct mcc_ast_identifier *identifier,
                     struct mcc_ast_parameter *parameter,
...
#define mcc_ast_delete(x) _Generic((x), \
		...
		struct mcc_ast_single_expression *:  mcc_ast_delete_single_expression,\
