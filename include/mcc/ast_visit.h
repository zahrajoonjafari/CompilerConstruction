...
typedef void (*mcc_ast_visit_single_expression_cb)(struct mcc_ast_single_expression *, void *userdata);
...
struct mcc_ast_visitor {
	...
	mcc_ast_visit_single_expression_cb single_expr;
	//mcc_ast_visit_single_expression_cb single_expr_parenth;
	//mcc_ast_visit_single_expression_cb single_expr_unary_op;
  //  mcc_ast_visit_single_expression_cb single_expr_identifier;
   // mcc_ast_visit_single_expression_cb single_expr_call;
